...
\begin{center}
    \textbf{\Huge \scshape Le Van Hieu} \\ \vspace{3pt}
    \small
    \faMobile \hspace{.5pt} \href{tel:0978073115}{+84 978 073 115}
    $|$
    \faAt \hspace{.5pt} \href{mailto:hieulevungtau@gmail.com}{hieulevungtau@gmail.com}
    $|$
    \faLinkedinSquare \hspace{.5pt} \href{https://www.linkedin.com/in/hieulevtvn}{LinkedIn}
    $|$
    \faGithub \hspace{.5pt} \href{https://github.com/hieuuuleee}{GitHub}
\end{center}
...
\section{Education}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeEducationHeading
      ...
      {B.Sc. in Computer Science}{Sep 2017 \textbf{--} Jun 2021}
    
    \resumeSubheading
      {Kocaeli Science High School
      }{Ba Ria - Vung Tau, Viet Nam}
      {High School Diploma}{Sep 2014 \textbf{--} Jun 2017}
...
\section{Skills}
  ...
  \resumeSubHeadingListStart
    \small{\item{
        ...
        \textbf{Languages:}{ Python, C/C++, Java, SQL, MATLAB} \\ \vspace{3pt}
        
        \textbf{Technologies:}{ Django, Flask, FastAPI, MySQL, PostgreSQL, MongoDB, Kibana, Grafana, Prometheus, Sentry, Git, Gitlab, Docker, Nginx, Crontab, Selenium, Scrapy, Amazon Web Services, Google Cloud Platform, Digital Ocean, Odoo, Jira} \\ \vspace{3pt}
